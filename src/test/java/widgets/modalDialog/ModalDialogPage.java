...
public class ModalDialogPage extends BasePage {
    ...
    public void addNewUser(){
        ...
        assertThat(userTableRowsEndSize).isEqualTo(userTableRowsStartSize+1);
        assertThat(newRowData.get(0).getText()).isEqualTo(name);
        assertThat(newRowData.get(1).getText()).isEqualTo(email);
        assertThat(newRowData.get(2).getText()).isEqualTo(password);
    }
}
