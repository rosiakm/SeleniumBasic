...
public class windowsTabsPage extends BasePage {
    ...
    String parentWindow = TestBase.getDriver().getWindowHandle();
    ...
    public void switchToNewBrowserWindow(){
        ...
        for (String windowHandle : TestBase.getDriver().getWindowHandles()) {
        ...
        TestBase.getDriver().switchTo().window(parentWindow);
